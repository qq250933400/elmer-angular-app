...
import { IConfig, IExConfig, IExConfigURL } from '../interface/config.interface';
import { CommonComponent } from './common.component';
export class CoreComponent extends CommonComponent {
    config: IConfig = <IConfig>baseConfig;
    baseConfig: IExConfig = null;
    serviceURLs: IExConfigURL = null;
    constructor(){
        super();
        const key = 'elmer';
        ...
        if(devConfig && this.isObject(devConfig)){
            ...
            this.baseConfig = devObj;
            this.serviceURLs = devObj.debug ? devObj.dev : devObj.prod;
        }
    }
